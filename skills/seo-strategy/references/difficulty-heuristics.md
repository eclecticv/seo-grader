...
> **Note**: This strategy was generated in free mode using SERP heuristics. Search volume and difficulty estimates are approximate. For precise keyword metrics, configure DataForSEO credentials in `.claude/seo-strategy.local.md`.
